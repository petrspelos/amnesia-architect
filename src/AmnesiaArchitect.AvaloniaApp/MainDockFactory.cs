...
using System.Linq;
using Avalonia.Data;
using AmnesiaArchitect.AvaloniaApp.Models.Documents;
using AmnesiaArchitect.AvaloniaApp.Models.Tools;
using AmnesiaArchitect.AvaloniaApp.ViewModels;
using AmnesiaArchitect.AvaloniaApp.ViewModels.Documents;
